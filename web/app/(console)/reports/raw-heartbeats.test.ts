...
assert.match(source, /selectedHeartbeatIDSet = useMemo\(\(\) => new Set\(selectedHeartbeatIDs\), \[selectedHeartbeatIDs\]\)/);
assert.match(source, /selectedHeartbeatIDSet\.has\(heartbeat\.id\)/);
