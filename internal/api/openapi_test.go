...
func TestOpenAPIDocsExposeRouteMethodsAndSecurity(t *testing.T) {
	...
	assertMethod("/api/v1/plugins/errors", "post")
	...
	assertOperationSecurity(t, doc.Paths["/api/v1/plugins/errors"]["post"], "BearerAuth")
	...
	assertRequestRef(t, doc.Paths["/api/v1/plugins/errors"]["post"], "#/components/schemas/PluginErrorRequest")
	...
	assertResponseRef(t, doc.Paths["/api/v1/plugins/errors"]["post"], "201", "#/components/schemas/PluginErrorResponse")
